...
class MetroAgi:
    ...
    def en_hizli_rota_bul(self, baslangic_id: str, hedef_id: str) -> Optional[Tuple[List[Istasyon], int]]:
        ...
        while pq:
            mevcut_süre, _, mevcut_istasyon, rota = heapq.heappop(pq)
            
            if mevcut_istasyon == hedef:
                return (rota, mevcut_süre)
            ...
            for komsu, sure in mevcut_istasyon.komsular:
                if komsu not in ziyaret_edildi:
                    yeni_süre = mevcut_süre + sure
                    heapq.heappush(pq, (yeni_süre, id(komsu), komsu, rota + [komsu]))
        return None
